You are performing a CONTEXT CHECKPOINT for LLM handoff.
...
6. **Blockers**: Any pending actions or issues to resolve

Format: Structured bullet points, max 400 words.
Focus on enabling seamless continuation.
Do NOT include tool call implementation details, only outcomes.
